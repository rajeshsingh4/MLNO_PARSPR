...
export default function BureauPullRequestConfirmationDialog(props) {
	...
	return (
		<Dialog open onClose={handleClose} maxWidth="md">
			...
			<DialogContent>
				<DialogContentText>Please fill the below fields to confirm your action.</DialogContentText>
				<TextField
					autoFocus
					margin="dense"
					id="status-field"
			...
			<DialogActions>
				...
				<Button disabled={formData.status === '' || formData.comment === ''} onClick={handleUpdate}>
					Update
				</Button>
			</DialogActions>
		</Dialog>
